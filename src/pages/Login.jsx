      ...
      <div class="login-box">
        <div class="login-form">
          <form action="/api/v1/users/login" method="POST">
            ...
            <Button variant='contained' className='btn1' onClick={() => { Navigate("/") }}>Login Now</Button>
            <br />
            <h2>or</h2>
            <br />
            <Button variant='contained' className='btn2' onClick={() => { Navigate("/register") }}>Register</Button>
            </div>
          </form>
        </div>
      </div>
